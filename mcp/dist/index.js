...
export default class CourierMcpServer extends McpServer {
    ...
    registerTools() {
        ...
        this.tool('get_config', 'Get the Courier tool configuration', {}, async () => {
            return {
                content: [
                    {
                        type: 'text',
        ...
        this.tool('issue_token', 'Generate a JWT authentication token for Courier. Ask for user id if not provided.', {
            user_id: z.string(),
        ...
        this.tool('send_message', 'Send a message to a user with Courier using title and body (no template)', {
            user_id: z.string(),
            title: z.string(),
            body: z.string(),
        ...
        this.tool('send_message_template', 'Send a message to a user with Courier using a template', {
            user_id: z.string(),
            template: z.string(),
            data: z.record(z.string(), z.string()).optional(),
